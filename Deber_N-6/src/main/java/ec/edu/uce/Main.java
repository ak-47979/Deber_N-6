...
public class Main {
    ...
    public static class App implements QuarkusApplication {
        ...
        public int run(String... args) throws Exception {
            ...
            Proyecto proyecto1 = new Proyecto("Inteligencia Artificial",timeInicio ,timeFin);

            Proyecto proyecto2 = new Proyecto("Robótica",timeInicio ,timeFin);
            ...
            profesorService.guardarPro(profesor,proyectos);
            return 0;
        }
